...
import runi.myddns.challenges.games.mobarmywars.GUIs.BundleGUI;
import runi.myddns.challenges.games.mobarmywars.Managers.Event.BundleManager;
import runi.myddns.challenges.games.mobarmywars.Managers.Event.TeamManager;
...
public class BundleListener implements Listener {
    ...
    public BundleListener(
        ...
        this.teamBundleKey = new NamespacedKey(game.getPlugin(), "team_bundle");
    }
